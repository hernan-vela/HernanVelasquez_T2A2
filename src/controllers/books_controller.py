...
# /book/<id> - GET - fetch a specific book
...
def create_book():
    ...
    #HOW TO VALIDATE publication_date HERE ACCORDING TO THE FORMAT?
    book = Book(
        ...
        publication_date_str = body_data.get("publication_date"),
...
# /book/<id> - PUT, PATCH - edit a book entry
